...
export function ProfessionnelsContent() {
  const { t } = useLanguage();
  const p = t.profiles.professionnels;
    ...
    <div>
      <section className="relative min-h-[60vh] overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/illustration-professionnels.png"
            alt={p.heroImageAlt}
            fill
            priority
      ...
      <section id="preclinique" className="scroll-mt-28 border-y bg-secondary py-12 md:py-16">
        <ProductSectionHeader
          eyebrow={p.precliniqueSection.eyebrow}
          title={p.precliniqueSection.title}
          description={p.precliniqueSection.description}
        />
      </section>
