        ...
        <div className="grid gap-6 md:grid-cols-2">
          {images.map((img) => (
            <a
              key={img.src}
              href={img.src}
              className="group rounded-3xl border bg-card p-4 shadow-sm transition hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
              target="_blank"
              rel="noreferrer"
            >
